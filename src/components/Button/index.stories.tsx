...
export const Anchors: React.FC = () => {
  return (
    <>
        ...
        {Object.values(variants).map((variant) => {
          return (
            <Box key={variant} mb="32px">
              {Object.values(scales).map((scale) => {
                return (
                  <Button as="a" href="https://yogi.fi" key={scale} variant={variant} scale={scale} external mr="8px">
      ...
      <Box>
        <Button as="a" href="https://yogi.fi" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://yogi.fi" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
