...
const useProps = () => {
  const [props, setProps] = useState({
    ...
    setLang: noop,
    currentLang: 'EN',
    yogiPriceUsd: 0.023158668932877668,
    links,
    profile: null,
  });
      ...
      <Menu {...props}>
        <div>
          ...
          <Text as="p">
            ...
            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet,
...
export const NotConnected: React.FC = () => {
  return (
    <BrowserRouter>
      <Menu account={null} login={noop} logout={noop} isDark toggleTheme={noop} langs={langs} setLang={noop} currentLang="EN" links={links}>
        <div>
          <h1>Page body</h1>
  ...
  return (
    <BrowserRouter>
      <Menu
        ...
        profile={{
          username: 'yogi',
          image: 'https://yogi.fi/images/nfts/blueberries-preview.png',
          profileLink: '/profile',
          noProfileLink: '/no-profile',
        }}
      >
